    ...
    <>
      ...
      {mobileOpen && (
        <div className="lg:hidden fixed inset-0 z-40">
          ...
          <div className="relative w-[260px] h-screen bg-neutral-950 text-white">
            {sidebar}
          </div>
        </div>
      )}
      ...
      {/* Desktop sidebar */}
      <div className="hidden lg:block fixed left-0 top-0 w-[260px] h-screen bg-neutral-950 text-white z-30">
        {sidebar}
      </div>
    </>
  );
